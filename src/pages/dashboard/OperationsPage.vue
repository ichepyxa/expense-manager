    ...
    <div class="w-full">
      ...
      <ul class="flex flex-col w-full">
        <template v-if="operations && operations.length > 0">
          <li class="gap-x-2 px-3 cursor-pointer not-last:border-b-2 border-gray-200 hover:bg-gray-200 transition-all duration-300 py-3 flex items-center w-full" v-for="operation in operations">
